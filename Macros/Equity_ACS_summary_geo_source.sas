/**************************************************************************
 Program:  Equity_ACS_summary_geo_source.sas
 Library:  ACS
...
%macro Equity_ACS_summary_geo_source( source_geo );
  ...
  %end;
  %else %do;
    %err_mput( macro=Equity_ACS_summary_geo_source, msg=Geograpy &source_geo is not supported. )
    %goto macro_exit;
  %end;
  ...
  ** Create new variables for summarizing **;
  ...
  data &source_ds_work;
    ...
    Pop18_34Years_&_years. = 
		sum(B01001e7 B01001e8 B01001e9 B01001e10 B01001e11 B01001e12 
			...
			Pop18_34YearsA_&_years.	= 
				...
				B01001Ee22 B0100EDe23 B01001Ee24 B01001Ee25 );
		...
		%moe_sum( var=B01001m7 B01001m8 B01001m9 B01001m10 B01001m11 B01001m12 
			...
			mPop18_34YearsA_&_years. = 
				%moe_sum( var=B01001Dm7 B01001Dm8 B01001Dm9 B01001Dm10 
					...
					B01001Em22 B0100mEm23 B01001Em24 B01001Em25 );
      ...
      ** Poverty **;
      ...
      ChildrenPovertyDefined_&_years. = 
        sum( B17001e4, B17001e5, B17001e6, B17001e7, B17001e8, B17001e9, 
			...
			ChildrenPovertyDefinedIOM_&_years. = 
			...
			ChildrenPovertyDefinedAIOM_&_years. = 
				sum(B17001Ce4 B17001Ce5 B17001Ce6 B17001Ce7 B17001Ce8 B17001Ce9 
					B17001Ce18 B17001Ce19 B17001Ce20 B17001Ce21 B17001Ce22 B17001Ce23 
					B17001Ce33 B17001Ce34 B17001Ce35 B17001Ce36 B17001Ce37 B17001Ce38 
					B17001Ce47 B17001Ce48 B17001Ce49 B17001Ce50 B17001Ce51 B17001Ce52 
	  ...
	  PersonsPovertyDefined_&_years. = B17001e1;
			...
			PersonsPovertyDefinedIOM_&_years. = sum(B17001Ce1 B17001Fe1 B17001Ge1);
			PersonsPovertyDefinedAIOM_&_years. = sum(B17001Ce1 B17001De1 B17001Ee1 B17001Fe1 B17001Ge1);
      ...
      mChildrenPovertyDefined_&_years. = 
        %moe_sum( var=B17001m4 B17001m5 B17001m6 B17001m7 B17001m8 B17001m9 
			...
			mChildrenPovertyDefinedIOM_&_years. = 
			...
			mChildrenPovertyDefinedAIOM_&_years. = 
				%moe_sum(var=B17001Cm4 B17001Cm5 B17001Cm6 B17001Cm7 B17001Cm8 B17001Cm9 
							B17001Cm18 B17001Cm19 B17001Cm20 B17001Cm21 B17001Cm22 B17001Cm23 
							B17001Cm33 B17001Cm34 B17001Cm35 B17001Cm36 B17001Cm37 B17001Cm38 
							B17001Cm47 B17001Cm48 B17001Cm49 B17001Cm50 B17001Cm51 B17001Cm52 
      ...
      mPersonsPovertyDefined_&_years. = B17001m1;
			...
			mPersonsPovertyDefinedIOM_&_years. = %moe_sum( var=B17001Cm1 B17001Fm1 B17001Gm1);
			mPersonsPovertyDefinedAIOM_&_years. = %moe_sum( var=B17001Cm1 B17001Dm1 B17001Em1 B17001Fm1 B17001Gm1);
      ...
      label
        ...
        PersonsPovertyDefined_&_years. = "Persons with poverty status determined, &_years_dash "
			...
			PersonsPovertyDefinedIOM_&_years. = "Persons with poverty status determined, American Indian/Alaska Native, other race, two or more races&_years_dash " 
			PersonsPovertyDefinedAIOM_&_years. = "Persons with poverty status determined, All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_dash " 
        ...
        ChildrenPovertyDefined_&_years. = "Children under 18 years old with poverty status determined, &_years_dash "
			...
			ChildrenPovertyDefinedIOM_&_years. = "Children under 18 years old with poverty status determined, American Indian/Alaska Native, other race, two or more races, &_years_dash " 
			ChildrenPovertyDefinedAIOM_&_years. = "Children under 18 years old with poverty status determined, All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_dash " 
        ...
        mPersonsPovertyDefined_&_years. = "Persons with poverty status determined, MOE, &_years_dash "
			...
			mPersonsPovertyDefinedIOM_&_years. = "Persons with poverty status determined, American Indian/Alaska Native, other race, two or more racesMOE, &_years_dash " 
			mPersonsPovertyDefinedAIOM_&_years. = "Persons with poverty status determined, All remaining groups other than Black, Non-Hispanic White, Hispanic, MOE, &_years_dash " 
        ...
        mChildrenPovertyDefined_&_years. = "Children under 18 years old with poverty status determined, MOE, &_years_dash "
			...
			mChildrenPovertyDefinedIOM_&_years. = "Children under 18 years old with poverty status determined, American Indian/Alaska Native, other race, two or more races, MOE, &_years_dash " 
			mChildrenPovertyDefinedAIOM_&_years. = "Children under 18 years old with poverty status determined, All remaining groups other than Black, Non-Hispanic White, Hispanic, MOE, &_years_dash " 
      ...
      ** Employment **;
      ...
      PopCivilianEmployed_&_years. = 
        sum( B23001e7, B23001e14, B23001e21, B23001e28, B23001e35, B23001e42, B23001e49, 
			...
			PopCivilianEmployedA_&_years. = sum(C23002De7 C23002De12 C23002De20 C23002De25 C23002Ee7 C23002Ee12 C23002Ee20 C23002Ee25);
      ...
      PopUnemployed_&_years. = 
        sum( B23001e8, B23001e15, B23001e22, B23001e29, B23001e36, B23001e43, B23001e50, 
			...
			PopUnemployedA_&_years. = sum(C23002De8 C23002De13 C23002De21 C23002De26 C23002Ee8 C23002Ee13 C23002Ee21 C23002Ee26);
	  ...
	  Pop16_64Employed_&_years. = 
			...
			Pop16_64EmployedA_&_years. = 
				sum(C23002De5 C23002De7 C23002De18 C23002De20 C23002Ee5 C23002Ee7 C23002Ee18 C23002Ee20);
	  ...
	  PopEmployedByOccAIOM_&_years. = sum(C24010Ce1 C24010De1 C24010Ee1 C24010Fe1 C24010Ge1);
			PopEmployedMngmtAIOM_&_years. = sum(C24010Ce3 C24010Ce9 C24010De3 C24010De9 C24010Ee3 C24010Ee9 C24010Fe3 C24010Fe9 C24010Ge3 C24010Ge9);
			PopEmployedServAIOM_&_years. = sum(C24010Ce4 C24010Ce10 C24010De4 C24010De10 C24010Ee4 C24010Ee10 C24010Fe4 C24010Fe10 C24010Ge4 C24010Ge10);
			PopEmployedSalesAIOM_&_years. = sum(C24010Ce5 C24010Ce11 C24010De5 C24010De11 C24010Ee5 C24010Ee11 C24010Fe5 C24010Fe11 C24010Ge5 C24010Ge11);
			PopEmployedNatResAIOM_&_years. = sum(C24010Ce6 C24010Ce12 C24010De6 C24010De12 C24010Ee6 C24010Ee12 C24010Fe6 C24010Fe12 C24010Ge6 C24010Ge12);
			PopEmployedProdAIOM_&_years. = sum(C24010Ce7 C24010Ce13 C24010De7 C24010De13 C24010Ee7 C24010Ee13 C24010Fe7 C24010Fe13 C24010Ge7 C24010Ge13);
	  ...
	  PopWorkEarn_&_years. = sum(B20005e5 B20005e28 B20005e52 B20005e75);
			...
			PopWorkEarnA_&_years. = sum(B20005De5  B20005De28 B20005De52 B20005De75 B20005Ee5 B20005Ee28 B20005Ee52 B20005Ee75);
	  ...
	  mPopEmployedByOccIOM_&_years. = %moe_sum( var=C24010Cm1 C24010Fm1 C24010Gm1);
			...
			mPopEmployedSalesIOM_&_years. = %moe_sum( var=C24010Cm5 C24010Cm11  24010Fm5 C24010Fm11 C24010Gm5 C24010Gm11);
	  ...
	  mPopEmployedByOccAIOM_&_years. = %moe_sum( var=C24010Cm1 C24010Dm1 C24010Em1 C24010Fm1 C24010Gm1);
			...
			mPopEmployedSalesAIOM_&_years. = %moe_sum( var=C24010Cm5 C24010Cm11 C24010Dm5 C24010Dm11 C24010Em5 C24010Em11 24010Fm5 C24010Fm11 C24010Gm5 C24010Gm11);
      ...
      label
		...
		PopEmployedByOccAIOM_&_years. = "Persons 16+ years old employed in civilian occupations, All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_dash "
			PopEmployedMngmtAIOM_&_years. = "Persons 16+ years old employed in management, business, science and arts occupations, All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_das "
		...
		PopWorkFTLess35K_&_years. = "Worked full-time with earnings less than $35000, &_years_dash "
			PopWorkFTLess35KB_&_years. = "Worked full-time with earning less than $35000, Black/African American, &_years_dash "
			PopWorkFTLess35KW_&_years. = "Worked full-time with earnings less than $35000, Non-Hispanic White, &_years_dash "
			PopWorkFTLess35KH_&_years. = "Worked full-time with earnings less than $35000, Hispanic/Latino, &_years_dash "
			PopWorkFTLess35KA_&_years. = "Worked full-time with earnings less than $35000, Asian, Native Hawaiian, and other Pacific Islander, &_years_dash "
			PopWorkFTLess35KIOM_&_years. = "Worked full-time with earnings less than $35000, American Indian/Alaska Native, some other race, two or more races, &_years_dash "
			PopWorkFTLess35KAIOM_&_years. = "Worked full-time with earnings less than $35000, All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_dash "
			PopWorkFTLess75K_&_years. = "Worked full-time with earnings less than $75000, &_years_dash "
		PopWorkFTLess75KB_&_years. = "Worked full-time with earning less than $75000, Black/African American, &_years_dash "
			PopWorkFTLess75KW_&_years. = "Worked full-time with earnings less than $75000, Non-Hispanic White, &_years_dash "
			PopWorkFTLess75KH_&_years. = "Worked full-time with earnings less than $75000, Hispanic/Latino, &_years_dash "
			PopWorkFTLess75KA_&_years. = "Worked full-time with earnings less than $75000, Asian, Native Hawaiian, and other Pacific Islander, &_years_dash "
			PopWorkFTLess75KIOM_&_years. = "Worked full-time with earnings less than $75000, American Indian/Alaska Native, some other race, two or more races, &_years_dash "
			PopWorkFTLess75KAIOM_&_years. = "Worked full-time with earnings less than $75000, All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_dash "
		...
		mPopEmployedByOccH_&_years. = "Persons 16+ years old employed in civilian occupations, Hispanic/Latino, MOE, &_years_dash "
	  	...
	  	mPopEmployedByOccA_&_years. = "Persons 16+ years old employed in civilian occupations, Asian, Native Hawaiian, or Other Pacific Islander, MOE, &_years_dash "
			mPopEmployedMngmtA_&_years. = "Persons 16+ years old employed in management, business, science and arts occupations, Asian, Native Hawaiian, or Other Pacific Islander, MOE, &_years_das "
		...
		mPopWorkFTLess35K_&_years. = "Worked full-time with earnings less than $35000, MOE, &_years_dash "
			mPopWorkFTLess35KB_&_years. = "Worked full-time with earning less than $35000, Black/African American, MOE, &_years_dash "
			mPopWorkFTLess35KW_&_years. = "Worked full-time with earnings less than $35000, Non-Hispanic White, MOE, &_years_dash "
			mPopWorkFTLess35KH_&_years. = "Worked full-time with earnings less than $35000, Hispanic/Latino, MOE, &_years_dash "
			mPopWorkFTLess35KA_&_years. = "Worked full-time with earnings less than $35000, Asian, Native Hawaiian, and other Pacific Islander, MOE, &_years_dash "
			mPopWorkFTLess35KIOM_&_years. = "Worked full-time with earnings less than $35000, American Indian/Alaska Native, some other race, two or more races, MOE, &_years_dash "
			mPopWorkFTLess35KAIOM_&_years. = "Worked full-time with earnings less than $35000, All remaining groups other than Black, Non-Hispanic White, Hispanic, MOE, &_years_dash "
		mPopWorkFTLess75K_&_years. = "Worked full-time with earnings less than $75000, MOE, &_years_dash "
			mPopWorkFTLess75KB_&_years. = "Worked full-time with earning less than $75000, Black/African American, MOE, &_years_dash "
			mPopWorkFTLess75KW_&_years. = "Worked full-time with earnings less than $75000, Non-Hispanic White, MOE, MOE, &_years_dash "
			mPopWorkFTLess75KH_&_years. = "Worked full-time with earnings less than $75000, Hispanic/Latino, MOE, &_years_dash "
			mPopWorkFTLess75KA_&_years. = "Worked full-time with earnings less than $75000, Asian, Native Hawaiian, and other Pacific Islander, MOE, &_years_dash "
			mPopWorkFTLess75KIOM_&_years. = "Worked full-time with earnings less than $75000, American Indian/Alaska Native, some other race, two or more races, MOE, &_years_dash "
			mPopWorkFTLess75KAIOM_&_years. = "Worked full-time with earnings less than $75000, All remaining groups other than Black, Non-Hispanic White, Hispanic, MOE, &_years_dash "
      ;
    ...
    ** Education **;
    ...
    Pop25andOverWHS_&_years. = 
      sum( B15002e11, B15002e12, B15002e13, B15002e14, B15002e28, B15002e29, B15002e30, B15002e31 );
			...
			Pop25andOverWHSAIOM_&_years. = 
				sum(C15002Ce4 C15002Ce5 C15002Ce6  C15002Ce9 C15002Ce10 C15002Ce11 
					C15002De4 C15002De5 C15002De 6 C15002De9 C15002De10 C15002De11 
					C15002Ee4 C15002Ee5 C15002Ee6 C15002Ee9 C15002Ee10 C15002Ee11 
					C15002Fe4 C15002Fe5 C15002Fe6  C15002Fe9 C15002Fe10 C15002Fe11 
					C15002Ge4 C15002Ge5 C15002Ge6  C15002Ge9 C15002Ge10 C15002Ge11);
	...
	Pop25andOverWSC_&_years. = 
		sum(B15002e12, B15002e13, B15002e14, B15002e15, B15002e16, B15002e17, B15002e18, B15002e29, 
			...
			Pop25andOverWSCA_&_years. = sum(C15002De5 C15002De6 C15002De10 C15002De11 C15002Ee5 C15002Ee6 C15002Ee10 C15002Ee11);
			...
			Pop25andOverWSCNB_&_years. = 
					sum(B06009e10 B06009e11 B06009e12 B06009e16 B06009e17 
						B06009e18 B06009e22 B06009e23 B06009e24);
    ...
    mPop25andOverWHS_&_years. = 
      %moe_sum( var=B15002m11 B15002m12 B15002m13 B15002m14 B15002m28 B15002m29 B15002m30 B15002m31 );
			...
			mPop25andOverWHSAIOM_&_years. = 
				%moe_sum( var=C15002Cm4 C15002Cm5 C15002Cm6  C15002Cm9 C15002Cm10 C15002Cm11 
							  C15002Dm4 C15002Dm5 C15002Dm 6 C15002Dm9 C15002Dm10 C15002Dm11 
							  C15002Em4 C15002Em5 C15002Em6 C15002Em9 C15002Em10 C15002Em11 
							  C15002Fm4 C15002Fm5 C15002Fm6  C15002Fm9 C15002Fm10 C15002Fm11 
							  C15002Gm4 C15002Gm5 C15002Gm6  C15002Gm9 C15002Gm10 C15002Gm11);
    ...
    ** Income **;
	...
	FamIncomeMore200k_&_years. = B19101e17;
		FamIncomeMore200kB_&_years. = B19101Be17;
		FamIncomeMore200kW_&_years. = B19101He17;
		FamIncomeMore200kH_&_years. = B19101Ie17;
		FamIncomeMore200kA_&_years. = sum(B19101De17 B19101Ee17);
		FamIncomeMore200kIOM_&_years. = sum(B19101Ce17 B19101Fe17 B19101Ge17);
		FamIncomeMore200kAIOM_&_years. = sum(B19101Ce17 B19101De17 B19101Ee17 B19101Fe17 B19101Ge17);
	...
	mFamIncomeLess75k_&_years. = 
		...
		B19101m8 B19101m9 B19101m10 B19101m11 B19101m12);
			...
			mFamIncomeLess75kAIOM_&_years. = 
				...
				B19101Gm2 B19101Gm3 B19101Gm4 B19101Gm5 B19101Gm6 B19101Gm7 
				B19101Gm8 B19101Gm9 B19101Gm10 B19101Gm11 B19101Gm12);
	mFamIncomeMore200k_&_years. = B19101m17;
			mFamIncomeMore200kB_&_years. = B19101Bm17;
			mFamIncomeMore200kW_&_years. = B19101Hm17;
			mFamIncomeMore200kH_&_years. = B19101Im17;
			mFamIncomeMore200kA_&_years. = %moe_sum( var=B19101Dm17 B19101Em17);
			mFamIncomeMore200kIOM_&_years. = %moe_sum( var=B19101Cm17 B19101Fm17 B19101Gm17);
			mFamIncomeMore200kAIOM_&_years. = %moe_sum( var=B19101Cm17 B19101Dm17 B19101Em17 B19101Fm17 B19101Gm17);
    ...
    label 
	  ...
	  FamIncome_&_years. = "Family income, &_years_dash "
			...
			FamIncomeA_&_years. = "Family income, Asian, Hawaiian, and other Pacific Islander, &_years_dashh "
	  ...
	  FamIncomeLess75k_&_years. = "Family income less than $75000, &_years_dash "
			FamIncomeLess75kB_&_years. = "Family income less than $75000, Black/African American, &_years_dash "
			FamIncomeLess75kW_&_years. = "Family income less than $75000, Non-Hispanic White, &_years_dash "
			FamIncomeLess75kH_&_years. = "Family income less than $75000, Hispanic/Latino, &_years_dash "
			FamIncomeLess75kA_&_years. = "Family income less than $75000, Asian, Hawaiian, and other Pacific Islander, &_years_dash "
			FamIncomeLess75kIOM_&_years. = "Family income less than $75000, American Indian/Alaska Native, other race, two or more races, &_years_dash "
			FamIncomeLess75kAIOM_&_years. = "Family income less than $75000,All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_dash "
	  FamIncomeMore200k_&_years. = "Family income more than $200,000, &_years_dash "
			FamIncomeMore200kB_&_years. = "Family income more than $200,000, Black or African American, &_years_dash "
			FamIncomeMore200kW_&_years. = "Family income more than $200,000, Non-Hispanic White, &_years_dash "
			FamIncomeMore200kH_&_years. = "Family income more than $200,000, Hispanic or Latino, &_years_dash "
			FamIncomeMore200kA_&_years. = "Family income more than $200,000, Asian, Native Hawaiian, and other Pacific Islander, &_years_dash "
			FamIncomeMore200kIOM_&_years. = "Family income more than $200,000, American Indian/Alaska Native, other race, two or more races, &_years_dash "
			FamIncomeMore200kAIOM_&_years. = "Family income more than $200,000, All remaining groups other than Black, Non-Hispanic White, Hispanic, &_years_dash "
	  ...
	  mFamIncomeLess75k_&_years. = "Family income less than $75000, MOE, &_years_dash "
			mFamIncomeLess75kB_&_years. = "Family income less than $75000, Black/African American, MOE, &_years_dash "
			mFamIncomeLess75kW_&_years. = "Family income less than $75000, Non-Hispanic White, MOE, &_years_dash "
			mFamIncomeLess75kH_&_years. = "Family income less than $75000, Hispanic/Latino, MOE, &_years_dash "
			mFamIncomeLess75kA_&_years. = "Family income less than $75000, Asian, Hawaiian, and other Pacific Islander, MOE, &_years_dash "
			mFamIncomeLess75kIOM_&_years. = "Family income less than $75000, American Indian/Alaska Native, other race, two or more races, MOE, &_years_dash "
			mFamIncomeLess75kAIOM_&_years. = "Family income less than $75000,All remaining groups other than Black, Non-Hispanic White, Hispanic, MOE, &_years_dash "
	  mFamIncomeMore200k_&_years. = "Family income more than $200,000, MOE, &_years_dash "
			mFamIncomeMore200kB_&_years. = "Family income more than $200,000, Black or African American, MOE, &_years_dash "
			mFamIncomeMore200kW_&_years. = "Family income more than $200,000, Non-Hispanic White, MOE, &_years_dash "
			mFamIncomeMore200kH_&_years. = "Family income more than $200,000, Hispanic or Latino, MOE, &_years_dash "
			mFamIncomeMore200kA_&_years. = "Family income more than $200,000, Asian, Native Hawaiian, and other Pacific Islander, MOE, &_years_dash "
			mFamIncomeMore200kIOM_&_years. = "Family income more than $200,000, American Indian/Alaska Native, other race, two or more races, MOE, &_years_dash "
			mFamIncomeMore200kAIOM_&_years. = "Family income more than $200,000, All remaining groups other than Black, Non-Hispanic White, Hispanic, MOE, &_years_dash "
    ...
    ** Housing **;
    ...
    label
	  NumHsgUnits_&_years. = "Housing units, &_years_dash "
	  ...
	  mNumHsgUnits_&_years. = "Housing units, &_years_dash"
  ...
  %if &_state_ab = dc %then %do;
    ...
    %Equity_ACS_summary_geo( anc2002, &source_geo )
    %Equity_ACS_summary_geo( anc2012, &source_geo )
    %Equity_ACS_summary_geo( city, &source_geo )
    %Equity_ACS_summary_geo( cluster_tr2000, &source_geo )
    %Equity_ACS_summary_geo( eor, &source_geo )
    %Equity_ACS_summary_geo( psa2004, &source_geo )
    %Equity_ACS_summary_geo( psa2012, &source_geo )
    %Equity_ACS_summary_geo( geo2000, &source_geo )
    %Equity_ACS_summary_geo( geo2010, &source_geo )
    %Equity_ACS_summary_geo( voterpre2012, &source_geo )
    %Equity_ACS_summary_geo( ward2002, &source_geo )
    %Equity_ACS_summary_geo( ward2012, &source_geo )
    %Equity_ACS_summary_geo( zip, &source_geo )
...
%mend Equity_ACS_summary_geo_source;
