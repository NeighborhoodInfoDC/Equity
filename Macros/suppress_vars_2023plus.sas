/**************************************************************************
 Program:  suppress_vars_2023plus.sas
 Library:  Equity
...
%do r=1 %to 6;
	...
	%let name=%scan(&racename.,&r.," ");
		...
		array e_est&race. {55} 
			...
			PctMortCstBrden&race._&_years.
			PctMortSCstBrden&race._&_years.
			PctNoMortCstBrden&race._&_years.
			PctNoMortSCstBrden&race._&_years.
			PctAllOwnCstBrden&race._&_years.
			PctAllOwnSCstBrden&race._&_years.
			PctRentCstBrden&race._&_years.
			PctRentSCstBrden&race._&_years.
			;
		...
		array e_moe&race. {55} 	
			...
			PctMortCstBrden&race._m_&_years.
			PctMortSCstBrden&race._m_&_years.
			PctNoMortCstBrden&race._m_&_years.
			PctNoMortSCstBrden&race._m_&_years.
			PctAllOwnCstBrden&race._m_&_years.
			PctAllOwnSCstBrden&race._m_&_years.
			PctRentCstBrden&race._m_&_years.
			PctRentSCstBrden&race._m_&_years.
			;
		...
		array e_cv&race. {55} 
			...
			cvPctMortCstBrden&race._&_years.
			cvPctMortSCstBrden&race._&_years.
			cvPctNoMortCstBrden&race._&_years.
			cvPctNoMortSCstBrden&race._&_years.
			cvPctAllOwnCstBrden&race._&_years.
			cvPctAllOwnSCstBrden&race._&_years.
			cvPctRentCstBrden&race._&_years.
			cvPctRentSCstBrden&race._&_years.
			;

		array e_upper&race. {55} 		
			...
			uPctMortCstBrden&race._&_years.
			uPctMortSCstBrden&race._&_years.
			uPctNoMortCstBrden&race._&_years.
			uPctNoMortSCstBrden&race._&_years.
			uPctAllOwnCstBrden&race._&_years.
			uPctAllOwnSCstBrden&race._&_years.
			uPctRentCstBrden&race._&_years.
			uPctRentSCstBrden&race._&_years.
			;

		array e_lower&race. {55} 		
			...
			lPctMortCstBrden&race._&_years.
			lPctMortSCstBrden&race._&_years.
			lPctNoMortCstBrden&race._&_years.
			lPctNoMortSCstBrden&race._&_years.
			lPctAllOwnCstBrden&race._&_years.
			lPctAllOwnSCstBrden&race._&_years.
			lPctRentCstBrden&race._&_years.
			lPctRentSCstBrden&race._&_years.
			;
