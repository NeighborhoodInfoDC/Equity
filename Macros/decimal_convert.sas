...
%macro decimal_convert;
	...
	%do r=1 %to 4;
		...
		%let name=%scan(&racename.,&r.," ");
			...
			array newvarsr_e&race. {27}
				...
				nPctPopUnder18Yrs&race._2010_14 nPctPop18_34Years&race._2010_14 
	...
	%end;
			...
			array oldvars_m {45}
				...
				PctOthRaceNonHispBridg_m_2010_14 
			...
			array newvars_e {45}
				...
				nPctOthRaceNonHispBridg_2010_14 
			...
			array newvars_m {45}
				...
				nPctOthRaceNonHisBridg_m_2010_14 
